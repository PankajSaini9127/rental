...
function IncrementType({disabled, Year, Percentage, Amount, label,increment ,onChange,name,partLabel}) {
  return (
    <>
...
const YearlyIncrement = ({monthlyRent, value,rent,increment,setIncrement,tenure,yearValue,setYearValue,disabled,partLabel }) => {
...
const TextFieldWrapper = ({ textAlignRight,disabled, label, placeHolder, value, name, onChange,partLabel }) => {
  return (
    <Grid item md={4} xs={4}>
